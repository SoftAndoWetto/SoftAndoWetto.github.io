...
description: "A challenging HTB Linux machine using web enumeration, PHP type juggling, Cacti RCE (CVE-2025-24367), Docker escape, and full root compromise."
...
Use this for it tho, theres a clue